...
const handleChange = (index,value) => {
    ...
    if(value.length > 1){
        ...
        const lastFilledIndex = newCode.firstLastIndex((digit) => digit !== '');
...
<h2 className='text-3xl font-bold mb-6 text-center bg-gradient-to-r from-green-400 to-emerald-500 text-transparent
        ...
        <form className='space-y-6'>
            <div className='flex justify-between'>
                {code.map((digit,index) => (
                    ...
                    className='w-12 h-12 text-center text-2xl bg-gray-700 font-bold text-white border-2
        ...
        <motion.button className='w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white 
